...
def make(app, serv):
    ...
    app.ent = tk.Entry(app.sub_fr, width=60)
    app.btn1 = tk.Button(app.sub_fr, width=10, font=60, text='prev')
    app.btn2 = tk.Button(app.sub_fr, width=10, font=60, text='next')
    app.btn3 = tk.Button(app.sub_fr, width=10, font=60, text='3D')
